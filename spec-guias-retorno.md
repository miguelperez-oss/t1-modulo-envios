...
- **2026-09-08 · v2.1** — Detalle alineado al Figma (nodos 17008-234054 y 17014-82962): **una guía por pantalla**. La guía original muestra la card "Guía original" con el link "Guía retorno: {n}" y solo su cronograma; la guía de retorno muestra "Guía retorno" con el link "Guía original: {n}" y el cronograma unificado (bandas "Guía creada (Retorno)" y "Guía creada (Original)"), en orden descendente. Los links navegan entre ambas. Resumen de cobro con la estructura de Figma: Subtotal · Cargos adicionales · Impuestos (IVA) · Total. En el listado, DHL/FedEx/99 minutos aparecen como **dos guías independientes** (la de retorno con ⟳ junto al número); el desplegable queda reservado a las paqueterías que retornan sobre la misma guía.
